# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2018-07-25 01:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nodegroup', models.CharField(max_length=255, verbose_name='主机组名称')),
                ('nodegroup_desc', models.CharField(max_length=255, verbose_name='主机组描述')),
            ],
            options={
                'verbose_name': '主机组',
        ...
        migrations.AddField(
            model_name='host',
            name='nodegroup',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmdb.NodeGroup', verbose_name='saltstack主机组'),
        ),
        migrations.AddField(
